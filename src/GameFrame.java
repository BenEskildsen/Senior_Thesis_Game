...
public class GameFrame extends JFrame implements Runnable{
    ...
    //this is the button to go back to the main menu
    ...
    //STATS
    private int thisGameAddAsteroids = 0;
    private int thisGameTries = 0;
    private int allTimeAddAsteroids = 0;
    private double allTimeAddAsteroidsAverage = 0;
    private int allTimeTries = 0;
    private double allTimeTriesAverage = 0;
    ...
    public GameFrame(int minA, int maxA){
        //SETTINGS
        //atleast how many asteroids do we want?
    ...
    public GameFrame(){
        ...
        //Initialize the back button and add it to the panel:
        ...
        while(true){
            ...
            if(equationType == 0){
                ...
                for (int k = 0; k<generator.nextInt(maxNumberOfAsteroids)+minNumberOfAsteroids; k++){
                    ...
                    transformedY = a * Math.sin(b*transformedX + phi)+c;
            ...
            allTimeAddAsteroids += thisGameAddAsteroids;
            allTimeTries += thisGameTries;
            numGames++;
            allTimeAddAsteroidsAverage = 1.0*allTimeAddAsteroids/numGames;
            allTimeTriesAverage = 1.0*allTimeTries/numGames;
            
            String thisGame = "Tries to complete this level: " + thisGameTries + "\nNumber of MATHstroids added on this level: " + thisGameAddAsteroids;
            String allTime = "Average tries per level: " + allTimeTriesAverage + "\nAverage number of MATHstroids added per level: " + allTimeAddAsteroidsAverage;
            //This is where the stats will be displayed:
            JOptionPane.showMessageDialog(null, "You destroyed all the MATHstroids! \n\n                         Stats: \n" + "You have played " + numGames + " game(s) \n" + thisGame + "\n" + allTime + "\n\n" + "Click OK to play again");
            
            thisGameTries = 0;
            thisGameAddAsteroids = 0;
    ...
    public class PaintSurfacePanel extends JComponent implements Runnable{
        ...
        public void paint(Graphics g){
            ...
            for (double k = -9; k <= 9; k++){
                Shape Xtick = new Line2D.Double((k+275)+(k*12.5*Math.PI),270,(k+275)+(k*12.5*Math.PI),280);
                g2.draw(Xtick);
            }
            ...
            //labeling the axes:
            g2.drawString("-pi", (int) (275-50*Math.PI-10), 295);
            g2.drawString("-pi/2", (int)(275-25*Math.PI-10), 295);
            g2.drawString("pi/2", (int)(275+25*Math.PI-10), 295);
            g2.drawString("pi", (int) (275+50*Math.PI-10), 295);
